...
//                print( self.tileArray[index1][index2].imageView.frame )
                print( self.tileArray[index1][index2].imageView.frame)
                UIView.animate(withDuration: 3.0, delay: 0.0, usingSpringWithDamping: 0.7, initialSpringVelocity: 0.0, options: UIViewAnimationOptions(), animations: ({
